      ...
      <div className="container mx-auto px-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <div className="text-left mb-12">
            ...
            <h1 className="font-serif whitespace-nowrap text-[8vw] md:text-[6vw] font-bold text-blue-900 leading-none tracking-wide">
              STAY CONNECTED
            </h1>
          </div>
        ...
        <div className="relative flex justify-center">
          <div className="w-[70%] h-[250px] rounded-lg overflow-hidden shadow-lg border-4 border-white translate-x-20 translate-y-20">
            <video
              ...
              src="https://www.pexels.com/download/video/26765315/" // replace with your video link
            />
          </div>
        </div>
      </div>
