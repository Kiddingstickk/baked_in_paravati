...
import hostelImage from "../assets/paul-pastourmatzis-r0J9sGBWFOc-unsplash.jpg";       // replace with your actual image
        ...
        >
          <div className="inline-block translate-x-3" style={{ transform: "translateZ(0)" }}>
            ...
            <p className="mt-6 text-gray-200 max-w-md text-lg">
              Baked in Parvati – Hostel, Kalga.  
              5 rooms with 4 dorm beds each.  
              Cozy, communal living for backpackers and explorers.
            </p>
          </div>
        </div>
